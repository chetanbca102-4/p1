...
public class BankApp {
    public static void main(String[] args) {
        BankCustomer customer = new BankCustomer("John Doe", "CUST123", "123 Main Street");
        BankTransaction transaction = new BankTransaction("SBI", "John Doe", "Savings", "SB123456789", 1000.50);
